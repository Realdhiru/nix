...
hl.animation({ leaf = "fadeLayersOut", enabled = true, speed = 2, bezier = "menu_decel" })
...
hl.animation({ leaf = "workspaces", enabled = true, speed = 6, bezier = "menu_decel", style = "slidefade 15%" })
hl.animation({ leaf = "specialWorkspace", enabled = true, speed = 3, bezier = "md3_decel", style = "slidefadevert 15%" })
-- hl.animation({ leaf = "specialWorkspace", enabled = true, speed = 2, bezier = "menu_decel", style = "fade" })